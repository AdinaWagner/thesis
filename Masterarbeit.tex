...
With regard to the scope of this thesis, and as eminent from the fundamental principles of foveal vision, saccades are the type of eye movement of particular relevance to the study of visuospatial attention (Kowler, 2011). Saccadic eye movements are controlled by a number of highly interconnected brain region, both cortical and subcortica (Munoz, 2002, see figure \ref{fig:saccregions}), but in the cortex, the FEF are seen as the principal region involved in oculomotor control (Leichtnetz \& Goldberg, 1988). The FEFs further involvement in visuospatial attentional processes emphasizes its role as a site of conversion for the selection of visual targets for saccades and visuospatial attention (Corbetta \& Shulman, 2002; Kowler, 2011). Thus, in regard to the study of visuopatial attention and eye movement they appear as an ideal subject of interest.
