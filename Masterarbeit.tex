...
In this thesis, therefore, I will explore differential activation differences with regard to attentional modulation in the left and right frontal eye field. \textbf{And now we need a clearly stated research question and ideally some hypothesis} Based on [study of muggleton, study of stefan] we hypothesize that a stronger endogenous attentional mode will be differentially related to stronger right FEF activation.\newline
\textbf{lets do another thesis overview here, just to be safe :D} \\
\textbf{finally add an outro}
